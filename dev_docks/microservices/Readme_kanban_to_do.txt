...
2. Реализовать Event Listener для добавления user_id в JWT-токен (раздел 4.4).
3. Создать Doctrine Entity Listener для сущности User для отправки событий в RabbitMQ (раздел 6.3).
================================================================================
