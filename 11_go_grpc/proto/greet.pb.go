...
const file_proto_greet_proto_rawDesc = "" +
	"\n" +
	"\x11proto/greet.proto\x12\vTestService\"\t\n" +
	"\aNoParam\"\"\n" +
	...
	"\bmessages\x18\x01 \x03(\tR\bmessages2\xca\x02\n" +
	"\fGreetService\x12<\n" +
	"\bSayHello\x12\x14.TestService.NoParam\x1a\x1a.TestService.HelloResponse\x12O\n" +
	"\x17SayHelloServerStreaming\x12\x16.TestService.NamesList\x1a\x1a.TestService.HelloResponse0\x01\x12N\n" +
	"\x14SayHelloClientStream\x12\x19.TestService.HelloRequest\x1a\x19.TestService.MessagesList(\x01\x12[\n" +
	"\x1eSayHelloBidirectionalStreaming\x12\x19.TestService.HelloRequest\x1a\x1a.TestService.HelloResponse(\x010\x01B\tZ\a./protob\x06proto3"
...
var file_proto_greet_proto_goTypes = []any{
	(*NoParam)(nil),       // 0: TestService.NoParam
	(*HelloRequest)(nil),  // 1: TestService.HelloRequest
	(*HelloResponse)(nil), // 2: TestService.HelloResponse
	(*NamesList)(nil),     // 3: TestService.NamesList
	(*MessagesList)(nil),  // 4: TestService.MessagesList
}
var file_proto_greet_proto_depIdxs = []int32{
	0, // 0: TestService.GreetService.SayHello:input_type -> TestService.NoParam
	3, // 1: TestService.GreetService.SayHelloServerStreaming:input_type -> TestService.NamesList
	1, // 2: TestService.GreetService.SayHelloClientStream:input_type -> TestService.HelloRequest
	1, // 3: TestService.GreetService.SayHelloBidirectionalStreaming:input_type -> TestService.HelloRequest
	2, // 4: TestService.GreetService.SayHello:output_type -> TestService.HelloResponse
	2, // 5: TestService.GreetService.SayHelloServerStreaming:output_type -> TestService.HelloResponse
	4, // 6: TestService.GreetService.SayHelloClientStream:output_type -> TestService.MessagesList
	2, // 7: TestService.GreetService.SayHelloBidirectionalStreaming:output_type -> TestService.HelloResponse
