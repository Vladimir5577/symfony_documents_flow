...
class Document
{
    ...
    private AbstractOrganization $organizationCreator;
    ...
    public function getOrganizationCreator(): AbstractOrganization
    {
        return $this->organizationCreator;
    }

    public function setOrganizationCreator(AbstractOrganization $organizationCreator): static
    {
