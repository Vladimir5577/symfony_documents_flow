 ...
 *
 * Удаление заготовки сносит заявки, которые на неё ссылаются, и снимает её
 * с дефолта вида заявки. Иначе внешний ключ просто обнулился бы, а заявки
 * остались бы без регламента, по которому их согласовали.
 *
 */
