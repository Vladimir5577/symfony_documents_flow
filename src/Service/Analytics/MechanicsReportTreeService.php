...
/**
 * Формирует данные отчётов «Механики» в виде:
 ...
 * (analytics_metrics.category = 'mechanics'). Иерархия строится по
 * analytics_board_version_metrics.parent_id.
 */
final class MechanicsReportTreeService
{
    private const CATEGORY = 'mechanics';
     ...
     * Доска находится по analytics_boards.category = 'mechanics'.
     *
     * @return array{
