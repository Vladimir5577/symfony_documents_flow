...
final class ContractApplicationPdfService
{
    ...
    private function writeTitle(TCPDF $pdf, string $title): void
    {
     ...
     */
    private function writeSection(TCPDF $pdf, string $heading, array $rows): void
    {
     ...
     * @param array<string, string|null> $rows
     */
    private function writeRows(TCPDF $pdf, array $rows): void
    {
        $labelWidth = 55;
        $valueWidth = 125;
