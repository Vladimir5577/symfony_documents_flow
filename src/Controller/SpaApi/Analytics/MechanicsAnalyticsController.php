...
use App\Service\Analytics\MechanicsReportTreeService;
use Symfony\Bundle\FrameworkBundle\Controller\AbstractController;
use Symfony\Component\HttpFoundation\JsonResponse;
use Symfony\Component\HttpFoundation\Request;
use Symfony\Component\Routing\Attribute\Route;

final class MechanicsAnalyticsController extends AbstractController
{
    ...
    /**
     * Отчёты «Механики» в виде дерева метрик по неделям.
     * Формат:
     *   { availableWeeks: [{ startDate, endDate }], weeks: [{ startDate, endDate, reports: [...] }] }
     */
    #[Route('/spa/api/analytics/mechanics/reports', name: 'spa_api_analytics_mechanics_reports', methods: ['GET'])]
    public function reports(
        Request $request,
        MechanicsReportTreeService $mechanicsReportTreeService,
    ): JsonResponse {
        ...
        return $this->json(
            $mechanicsReportTreeService->buildWeeks($orgId, $from, $to, $limit, $offset),
        );
    }

    /**
     * Плоский список подтверждённых отчётов «Механики» без метрик.
     * Формат:
     ...
     */
    #[Route('/spa/api/analytics/mechanics/reports/list', name: 'spa_api_analytics_mechanics_reports_list', methods: ['GET'])]
    public function reportsList(
        ...
        return $this->json(
            $mechanicsReportTreeService->getAllReports($orgId, $from, $to, $page, $perPage),
        );
    }
